            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="category-card quality">
                        ...
                        <div class="sub-category">
                            <a href="{{ route('login', ['app' => 'finished-product-inspection']) }}" class="sub-category-title sub-category-link">
                                <i class="bi bi-check2-square"></i>
                                Finished Product Inspection
                            </a>
                            <div class="menu-grid">
                                <a href="{{ route('login', ['app' => 'finished-product-inspection']) }}" class="menu-item">
                                    <div class="menu-icon">
                                        <i class="bi bi-check2-square"></i>
                                    </div>
