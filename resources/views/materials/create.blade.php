        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Add new material to inventory</p>
                </div>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select @error('type') is-invalid @enderror" id="type"
                                                ...
                                                <option value="Part" {{ old('type') == 'Part' ? 'selected' : '' }}>Part
                                                </option>
                                                <option value="Material" {{ old('type') == 'Material' ? 'selected' : '' }}>
                                                    Material</option>
                                                <option value="Consumable"
                                                    {{ old('type') == 'Consumable' ? 'selected' : '' }}>Consumable</option>
                                                <option value="Tool" {{ old('type') == 'Tool' ? 'selected' : '' }}>Tool
                                                </option>
                                            </select>
                                            @error('type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                        rows="3" placeholder="Material description...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('alternative_unit') }}" placeholder="e.g., gram, box">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.0001"
                                                ...
                                                value="{{ old('conversion_factor') }}" placeholder="e.g., 1000">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('lead_time_days', 0) }}" placeholder="0">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('current_stock', 0) }}" placeholder="0" required>
                                            @error('current_stock')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('packing_unit') }}" placeholder="Pack/Drum/Box"
                                                required>
                                            @error('packing_unit')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="capacityPerPack">Capacity Per Pack <span class="text-danger">*</span></label>
                                            <input type="number" step="1"
                                                class="form-control @error('capacity_per_pack') is-invalid @enderror"
                                                id="capacity_per_pack" name="capacity_per_pack"
                                                value="{{ old('capacity_per_pack') }}" placeholder="e.g., 5">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('storage_location') }}" placeholder="e.g., Warehouse A-01">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" name="specifications[0][name]"
                                                    placeholder="Specification Name (e.g., Melting Point)">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control"
                                                    name="specifications[0][value]" placeholder="Value (e.g., 65-70°C)">
                                            </div>
                                            <div class="col-md-1">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="mb-3">
                                        <img id="image-preview" src="{{ asset('assets/compiled/svg/placeholder.svg') }}"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <button type="submit" class="btn btn-primary btn-block mb-2">
                                    <i class="bi bi-save"></i> Create Material
                                </button>
                                <a href="{{ route('materials.index') }}" class="btn btn-secondary btn-block">
