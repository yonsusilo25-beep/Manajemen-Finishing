...
class FinishedProductInspectionController extends Controller
{
    public function index()
    {
        ...
        $stats = [
            ...
            'pending_requests' => Request::where('user_id', $user->id)
                ->whereIn('status', ['submitted', 'checking_stock'])
                ->count(),
        ...
        return view('finished-product-inspection.index', compact('stats', 'recent_requests', 'low_stock'));
    }
}
